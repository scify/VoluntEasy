...
class ErrorHandler
{
    ...
    {
        $this->handleError(E_USER_DEPRECATED, 'The ' . __METHOD__ . ' method is deprecated since version 2.6 and will be removed in 3.0. Use the handleError() method instead.', '/home/xrist/Projects/VoluntEasy/VoluntEasy/vendor/symfony/debug/ErrorHandler.php', __LINE__, array());
...
class Carbon extends DateTime
{
    ...
    public static function setLocale($locale)
    {
        ...
        static::translator()->addResource('array', require '/home/xrist/Projects/VoluntEasy/VoluntEasy/vendor/nesbot/carbon/src/Carbon' . '/Lang/' . $locale . '.php', $locale);
    }
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        if (env('MODE') == 'ekpizo') {
            $this->app->bind('Interfaces\\ConfigurationInterface', 'Dependencies\\ekpizo\\configuration\\Configuration');
            $this->app->bind('Interfaces\\ReportsInterface', 'Dependencies\\ekpizo\\services\\ReportsService');
            $this->app->bind('Interfaces\\VolunteerInterface', 'Dependencies\\ekpizo\\services\\VolunteerServiceImpl');
            $this->app->bind('Interfaces\\RatingInterface', 'Dependencies\\ekpizo\\services\\RatingServiceImpl');
        } else {
            if (env('MODE') == 'municipality') {
                $this->app->bind('Interfaces\\ConfigurationInterface', 'Dependencies\\municipality\\configuration\\Configuration');
                $this->app->bind('Interfaces\\ReportsInterface', 'Dependencies\\municipality\\services\\ReportsService');
                $this->app->bind('Interfaces\\VolunteerInterface', 'Dependencies\\municipality\\services\\VolunteerServiceImpl');
                $this->app->bind('Interfaces\\RatingInterface', 'Dependencies\\municipality\\services\\RatingServiceImpl');
            } else {
                if (env('MODE') == 'scify') {
                    $this->app->bind('Interfaces\\ConfigurationInterface', 'Dependencies\\scify\\configuration\\Configuration');
                    $this->app->bind('Interfaces\\ReportsInterface', 'Dependencies\\scify\\services\\ReportsService');
                    $this->app->bind('Interfaces\\VolunteerInterface', 'Dependencies\\scify\\services\\VolunteerServiceImpl');
                    $this->app->bind('Interfaces\\RatingInterface', 'Dependencies\\scify\\services\\RatingServiceImpl');
                }
            }
        }
    }
