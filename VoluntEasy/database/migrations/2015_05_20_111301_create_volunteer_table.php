...
class CreateVolunteerTable extends Migration {
    ...
    public function up() {
        ...
        Schema::create('volunteers', function ($table) {
            ...
            $table->string('participation_reason', 600)->nullable();
            $table->string('participation_previous', 600)->nullable();
            $table->string('participation_actions', 600)->nullable();
            $table->string('home_tel')->nullable();
            $table->string('work_tel')->nullable();
            $table->string('cell_tel')->nullable();
            $table->string('fax')->nullable();
            $table->string('email')->unique();
            $table->string('extra_lang', 300)->nullable();
            $table->string('work_description', 600)->nullable();
            $table->string('specialty', 300)->nullable();
            $table->string('department', 300)->nullable();
            $table->string('additional_skills', 600)->nullable();
            $table->string('computer_usage_comments', 300)->nullable();
