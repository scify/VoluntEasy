        ...
        <div class="row m-b-lg">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <small class="help-block text-primary under18"
                                   style="display:none;">{{ trans('entities/volunteers.volunteerUnderage') }}
                            </small>
                        </div>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <em>{{ trans('entities/volunteers.livesInCurrCountryExpl') }}</em>
                </div>
            </div>
            <div class="col-md-4">
                <div class="row">
