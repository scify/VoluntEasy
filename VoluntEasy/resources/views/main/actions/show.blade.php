        ...
        <div role="tabpanel">
            ...
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li role="presentation"><a href="#tab2" role="tab" data-toggle="tab" aria-expanded="false">Task
                        Board</a></li>
                <li role="presentation" class="active"><a href="#tab3" role="tab" data-toggle="tab"
                ...
                <div role="tabpanel" class="tab-pane" id="tab1">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <p><strong>Αριθμός εθελοντών: {{ $action->volunteerSum }} <i class="fa fa-question-circle"
                            ...
                            <p><strong>URL δημόσιας σελίδας:</strong> <a href="{{ url('participate/'.$action->publicAction->public_url) }}" target="_blank">{{ url('participate/'.$action->publicAction->public_url) }}</a></p>
                            @endif
                        </div>
                        <div class="col-md-4">
