                    ...
                    <div class="panel panel-white">
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                   <p>Σημειώστε τις ώρες που απασχολήθηκε ο εθελοντής στη δράση.</p>

                                    <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            {!! Form::formInput('hours', 'Ώρες:', $errors, ['class' => 'form-control']) !!}
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            {!! Form::formInput('minutes', 'Λεπτά:', $errors, ['class' => 'form-control']) !!}
                                        </div>
                                    </div>
                                    </div>
                                </div>
