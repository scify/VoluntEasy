...
{{--<form action="/ethelontismos/symetoxh" accept-charset="UTF-8" method="post" id="ethelontismosform-my-form">--}}
    <div>
        ...
        <br><a href="/ethelontismos/symetoxh #oroi" class="intlink lightbox-processed"
               rel="lightmodal[search|width:600px; height:400px; scrolling:none;]"><strong>Όροι και Προϋποθέσεις
                Συμμετοχής</strong></a>
        <div style="display:none">
            <div id="oroi" style="text-align:left;">
                ...
                <p>Κανένα άλλο δικαίωμα ή απαίτηση έχω έναντι του Γραφείου Εθελοντισμού.</p></div>
        </div>
